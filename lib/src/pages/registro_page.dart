...
_registroForm(BuildContext context){
  ...
  return SingleChildScrollView(
     child: Column(
       children: <Widget>[
         ...
         TextButton(
           child: Text('Ya tienes una cuenta?, Regresar'),
...
Widget _crearPassword(LoginStream lStream){
 ...
 Widget _crearBotonSubmit(LoginStream lStream){
   ...
   return RaisedButton(
       child: Container(
          ...
          child: Text('Registrarme',style: TextStyle(fontSize: 17.0, fontWeight: FontWeight.w500)),
       ),
       ...
       onPressed: snapshot.hasData?  (){_registro(context, lStream);} : null,
   );
   });
 ...
 Widget _crearFondo(BuildContext context){
  ...
  _registro(BuildContext context,LoginStream lStream) async{

   Map info = await uProvider.nuevoUsuario(lStream.email, lStream.password);
